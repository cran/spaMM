...
if (spaMM.getOption("example_maxtime")>71) { # actually faster but don't run it in every 'long test'
  ...
  # timings:
  ##### New default use_ZA_L=TRUE:
  # v3.5.141 29.24user (and LevM 70.25user)
