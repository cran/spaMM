...
if (is.null(corrpars[["1"]])) { ## old sp2 code
  testthat::expect_equal(attr(corrpars,"type"),list(nu="fix",Nugget="outer",rho="outer"))
  testthat::expect_equal(corrpars$Nugget,0.0458,tolerance=5e-5) 
