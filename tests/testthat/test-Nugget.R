...
if (is.null(loafit$corrPars[["1"]])) { ## old sp2 code
...
} else { # future spaMM3.0 code
  testthat::expect_equal(attr(loafit$corrPars,"type")[["1"]],list(nu="fix",Nugget="outer",rho="outer"))
  testthat::expect_equal(loafit$corrPars[["1"]]$Nugget,0.0458,tolerance=5e-5) 
}
