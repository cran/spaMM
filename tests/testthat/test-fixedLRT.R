...
if ( .is_spprec_fit(fl$fullfit)) {
  warning("new test needed here in test-fixedLRT.R")
} else testthat::expect_equal(fl$BartBootLRT$p_value,structure(0.008546614,boot_type="marginal"),tolerance=1e-5)
